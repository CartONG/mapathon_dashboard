...
export class CONSTANTS {
  ...
  readonly TASKING_MANAGER_URLS: { [key:string] : { 'abbreviatedOptions': string, 'apiURL': string , 'projectURL': string, 'summaryAPI': string}} = {
    'Humanitarian OSM Team': {
      'abbreviatedOptions': '/?abbreviated=true',
      'apiURL': 'https://tasking-manager-tm4-production-api.hotosm.org/api/v2/projects/',
